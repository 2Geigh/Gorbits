...
const Mars = new Planet(
                            {"x": Viewport.width_pixels / 2, "y": 540}, // position
...
const Cassiopeia = new Bullet(
                                {"x": Viewport.width_pixels/2 - (2*Mars.radius), "y": Viewport.height_pixels/2}, // position
                                {"x": 100, "y": 0}, // velocity
                                10, // radius
                                20, // mass
                                "blue", // color
...
const handleCollision = (bullet: Bullet, game_objects: Array<(Planet | Bullet)>) => {
...
const GameplayLoop = setInterval(() => {
                                        ...
                                        if (!Viewport.inGameplayLoop) { clearInterval(GameplayLoop) };
